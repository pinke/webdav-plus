...
public interface IWebdavStore {
     ...
     * {@link #commit(net.sf.webdav.ITransaction transaction)} or
     * {@link #rollback(net.sf.webdav.ITransaction transaction)}. If only non-read methods
     * have been called, the request will be terminated by a
     * {@link #commit(net.sf.webdav.ITransaction transaction)}. This method will be
